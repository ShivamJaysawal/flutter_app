...
//void main() => runApp(Text("Hello Flutter",textDirection: TextDirection.ltr));
            ...
            Expanded(
              child: Container(
                ...
                child: RaisedButton(
                  ...
                  onPressed: methodInParent, // calls method in child
                ),
              ),
            ),
            Expanded(
      ...
      child: Column(
        ...
        children: <Widget>[
          ...
          RaisedButton(
            ...
            onPressed: _incrementCounterchild, // calls method in parent
          ),
